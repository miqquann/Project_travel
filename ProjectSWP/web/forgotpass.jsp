<%-- 
    Document   : Forgotpass
    Created on : May 15, 2024, 10:50:59 PM
    Author     : thait
--%>
    ...
    <body>
        <div class="form-container">
            ...
            <form action="forgot" method="post">
                ...
                New password<input type="password" name="password" value="" onclick="hideError()"/>
                Confirm password<input type="password" name="confirm" value="" onclick="hideError()"/>
                <input type="hidden" name="email" value="${requestScope.email}" />
                <input type="submit" value="OK" class="submit-button" /><br/>
            </form>
        </div>
