<%-- 
    Document   : listRegisteredUser
    Created on : Jun 7, 2024, 12:30:34 AM
    Author     : Admin
--%>
...
<!--                                                    <div class="select">
                                                ...
                                                <form action="searchRegisteredUser" method="post" class="form-search">
                                                    <fieldset class="name">
...
<!--                                            <li>
                                            ...
                                            <ul class="flex flex-column">
                                                <c:forEach items="${listRegisteredUser}" var="l" >
                                                ...
                                                <c:if test="${totalPages > 1}">
                                                    <ul class="wg-pagination">
                                                        <c:if test="${currentPage > 1}">
                                                            <li>
                                                                <a href="listRegisteredUser?page=${currentPage - 1}&userReInPage=${recordsPerPage}"><i class="icon-chevron-left"></i></a>
                                                            </li>
                                                        </c:if>
                                                        <c:forEach begin="1" end="${totalPages}" var="i">
                                                            <li class="${i == currentPage ? 'active' : ''}">
                                                                <a href="listRegisteredUser?page=${i}&userReInPage=${recordsPerPage}">${i}</a>
                                                            </li>
                                                        </c:forEach>
                                                        <c:if test="${currentPage < totalPages}">
                                                            <li>
                                                                <a href="listRegisteredUser?page=${currentPage + 1}&userReInPage=${recordsPerPage}"><i class="icon-chevron-right"></i></a>
                                                            </li>
                                                        </c:if>
                                                    </ul>
                                                </c:if>
