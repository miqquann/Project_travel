<%-- 
    Document   : hotelfavorite
    Created on : Jun 18, 2024, 12:47:57 AM
    Author     : thait
--%>
        ...
        <div class="contain-full">
            ...
            <main>
                <div class="hotel-container">
                    <c:forEach items="${requestScope.listhotelfavorite}" var="l">
                        <div class="hotel-row">
                            <div class="hotel-images">
                                <a href="detailhotel?id=${l.id}">
                            ...
                            <div class="hotel-actions">
                                <a href="removefavoritehotel?hotel_id=${l.id}">Bỏ thích</a>
                            </div>
                        </div>
                    </c:forEach>
                </div>
