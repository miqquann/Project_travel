                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                ...
                                <!-- form-add- -->
                                <form action="updatetour" method="post" onsubmit="return validateForm()" enctype="multipart/form-data" class="tf-section-2 form-add-product">
        <div class="wg-box">
            <fieldset class="name">
                <div class="body-title mb-10">Tên tour<span class="tf-color-1">*</span></div>
                <input id="nameInput" class="mb-10" type="text" placeholder="Tên" value="${t.tour_name}" name="name" tabindex="0" aria-required="true" >
                <input style="display: none" value="${t.tour_id}" name="id" >
                <span class="error-message" style="color:red"></span>
            </fieldset>
            <fieldset class="quanlity">
                <div class="body-title mb-10">Số lượng người tối đa<span class="tf-color-1">*</span></div>
                <input id="quantityInput" class="mb-10" name="quantity" value="${t.quantity}" type="number" placeholder="Số lượng "  aria-required="true" >
                <span class="error-message" style="color:red"></span>
            </fieldset>

            <fieldset class="description">
                <div class="body-title mb-10">Mô tả <span class="tf-color-1">*</span></div>
                <textarea id="describeInput" class="mb-10" name="description" placeholder="Description" tabindex="0" aria-required="true" >${t.tour_describe}</textarea>
                <span class="error-message" style="color:red"></span>
            </fieldset>
        </div>
        <div class="wg-box">
            <fieldset>
                ...
                <div class="upload-image mb-16">
                    <div class="item up-load">
                        <img style="border-radius: 10px;object-fit: cover" width="100%" height="auto" src="${t.tour_img}" alt="" id="imagePreview" onclick="triggerFileInput('uploadInput')"/>
                    ...
                    <div class="info">
                        ...
                        <select id="locationId" name="locationId" >
                            <c:forEach var="lc" items="${requestScope.listcity}">
                                <option value="${lc.id}" ${(t.location_id == lc.id)?"selected":""}>${lc.city}</option>
                            </c:forEach>
                        </select>
                        <span class="error-message" style="color:red"></span>
                    </div>
            ...
            <div class="cols gap22">
                <fieldset class="quanlity">
                    ...
                    <input id="tourPrice" class="mb-10" name="price" type="number" placeholder="Giá" value="${t.price}"  aria-required="true">
                    <span class="error-message" style="color:red"></span>
                </fieldset>
            </div>
            <div class="cols gap10">
                <a href="#"><button class="tf-button w-full" type="submit">Chỉnh sửa tour</button></a>
            </div>
        </div>
    </form>
                                <!-- /form-add-product -->
